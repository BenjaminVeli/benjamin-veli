      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-6">
          <div className="md:text-left text-center">
            ...
            <p className="font-normal text-lg sm:text-xl text-neutral-900">Impulsamos tu presencia digital con soluciones innovadoras en desarrollo web y creación de software personalizado.</p>
            <div className="mt-10 sm:mt-12 flex items-center flex-col gap-4 md:flex-row">
              <Link href="/contacto" className="font-medium bg-white hover:bg-zinc-950 border rounded-md border-zinc-950 py-2.5 px-6 transition-all duration-300 text-zinc-950 hover:text-white text-center">
                Contáctanos
              </Link>
              <Link href="/sobre-nosotros" className="font-medium inline-block bg-customGreen hover:bg-zinc-950 border rounded-md border-customGreen py-2.5 px-6 transition-all duration-300 text-black hover:text-white">
                Quiénes Somos
              </Link>
            </div>
          </div>
